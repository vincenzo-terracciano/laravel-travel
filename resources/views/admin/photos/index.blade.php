...
@section('content')
    <div class="container py-3">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <h5>Foto per il viaggio: {{ $travel->title }} a {{ $travel->destination_city }}, {{ $travel->destination_country }}</h5>
            <a href="{{ route('admin.travels.photos.create', $travel->id) }}" class="btn btn-success">
